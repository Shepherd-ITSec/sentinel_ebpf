...
def build_sequence_frequency_fusion(cfg: "DetectorConfig") -> BuildingBlock:
  ...
  seq = FeatureDictExtractorBlock(seq_extractor, "sequence", block_uid="pipeline:las_gas:sequence_dict")
  las = SequenceNextTokenMLPBlock(seq, cfg, block_uid="pipeline:las_gas:las_mlp")

  extractor = build_feature_extractor(cfg)
  fe = FeatureDictExtractorBlock(extractor, "frequency", block_uid="pipeline:las_gas:freq_dict")
