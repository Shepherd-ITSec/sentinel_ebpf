#!/usr/bin/env python3
"""Evaluate detector anomaly outputs against labels NDJSON."""
...
def main() -> None:
  ap = argparse.ArgumentParser(description="Evaluate replay anomalies against labels NDJSON")
  ap.add_argument("--labels", required=True, help="Path to labels ndjson (event_id, sus, evil per line)")
